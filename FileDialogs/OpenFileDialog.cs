...
public sealed class OpenFileDialog : IFileDialog {
    ...
    public OpenFileDialog AddExtensionFilter(NonEmptyString description, NonEmptyString extension) => AddFilter(FileFilter.CreateFromExtension(description, extension));
    public OpenFileDialog AddFilter(NonEmptyString description, NonEmptyString filter) => AddFilter(FileFilter.Create(description, filter));
